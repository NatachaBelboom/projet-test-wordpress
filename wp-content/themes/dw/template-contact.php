...
<?php if (have_posts()): while (have_posts()): the_post(); ?>
    <main class="layout contact">
            ...
            <form action="<?= get_home_url() ?>/wp-admin/admin-post.php" method="POST" class="contact__form form">
                ...
                <div class="form__field">
                    <label for="rules" class="form__label">
                        ...
                        <span class="form__checklabel"><?= str_replace(':conditions', '<a href="#">' . __('conditions générales d\'utilisation', 'dw') . '</a>', __('J\'ai lu et j\'accepte les :conditions.', 'dw')); ?></span>
                    </label>
        ...
        <?php else: ?>
            <p class="form__feedback"><?= __('Merci de nous avoir contacté. A bientot!', 'dw') ?></p>
