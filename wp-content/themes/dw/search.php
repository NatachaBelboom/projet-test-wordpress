...
<main class="layout">
    <section class="results">
        ...
        <div class="results__container">
            ...
            <?php endwhile; else: ?>
                <p class="results__empty">Il n' a pas de résultat à afficher</p>
            <?php endif; ?>
        </div>
    </section>
    <section class="results">
                ...
                <article class="trip">
                    ...
                    <div class="trip__card">
                        <header class="trip__head">
                            ...
                            <p class="trip__date"><time datetime="date('c', strtotime(get_field('departure_date', false, false)))"><?= ucfirst(date_i18n('F , Y', strtotime(get_field('departure_date', false, false)))) ?></time></p>
                        </header>
